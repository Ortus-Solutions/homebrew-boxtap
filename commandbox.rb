class Commandbox < Formula
  ...
  devel do
    url "http://integration.stg.ortussolutions.com/artifacts/ortussolutions/commandbox/4.0.1-alpha/commandbox-bin-4.0.1-alpha.zip?build=00022"
    sha256 "ba2d4b62b33d7a30a4203f39cd93834da4d67279d2b2973115c33f476b0d0ecb"
  end
